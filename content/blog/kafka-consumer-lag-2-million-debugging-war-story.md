...
description: "Our order events fell 2 million messages behind and nobody noticed for hours. A practical walkthrough of diagnosing Kafka consumer lag — partitions, rebalances, poison messages — and the fixes that got us back to real time."
date: "2026-02-20"
author: "Tushar Agrawal"
tags: ["Apache Kafka", "Consumer Lag", "Event-Driven Architecture", "Debugging", "Distributed Systems", "Backend Architecture", "Message Queues", "Performance"]
...
Here is how I found the cause and dug us out. If you are new to Kafka, my [event streaming deep-dive](/blog/apache-kafka-event-streaming-deep-dive) and [event-driven architecture guide](/blog/event-driven-architecture-kafka) cover the concepts I lean on here.
...
For the broader patterns, see [Apache Kafka: Event Streaming Deep Dive](/blog/apache-kafka-event-streaming-deep-dive), and for how Kafka compares to other brokers, [message queues: RabbitMQ vs Redis vs Kafka](/blog/message-queues-rabbitmq-redis-kafka-comparison).

**Related reading:**
- [Apache Kafka: Event Streaming Deep Dive](/blog/apache-kafka-event-streaming-deep-dive)
...
- [Observability with Prometheus, Grafana & Jaeger](/blog/observability-prometheus-grafana-jaeger-guide)
