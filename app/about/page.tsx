      ...
      <div className="max-w-7xl mx-auto px-4 md:px-8 lg:px-16 pt-24 pb-20">
        ...
        <article className="prose prose-invert prose-lg max-w-none">
          ...
          <section className="mb-12">
            ...
            <ul className="text-neutral-300 text-lg space-y-2 mt-4">
          ...
          <section className="mb-12">
            ...
            <div className="bg-neutral-900/50 border border-neutral-800 rounded-2xl p-6 mb-6">
              ...
              <p className="text-neutral-400 mt-1">May 2023 - Present | New Delhi, India</p>
            ...
            <div className="bg-neutral-900/50 border border-neutral-800 rounded-2xl p-6 mb-6">
              ...
              <p className="text-neutral-400 mt-1">Feb 2023 - May 2023 | Jaipur, India</p>
              <ul className="text-neutral-300 mt-4 space-y-2">
            ...
            <div className="bg-neutral-900/50 border border-neutral-800 rounded-2xl p-6">
              ...
              <p className="text-neutral-400 mt-1">Jun 2022 - Dec 2022 | Gurugram, India</p>
              <ul className="text-neutral-300 mt-4 space-y-2">
          ...
          <section className="mb-12">
            ...
            <div className="grid gap-6">
              <div className="bg-neutral-900/50 border border-neutral-800 rounded-2xl p-6">
                ...
                <p className="text-neutral-300 mt-2">Enterprise inventory management platform serving 20+ businesses with 80+ users across Uttar Pradesh. Built with Go, Flutter, Redis, Kafka, and PostgreSQL.</p>
              </div>

              <div className="bg-neutral-900/50 border border-neutral-800 rounded-2xl p-6">
                <h3 className="text-xl font-bold text-white">FOMOA - India-First AI Search</h3>
                <p className="text-neutral-300 mt-2">AI search engine optimized for Indian context with Hindi/Hinglish support, trained on 86,000+ samples from 150+ authoritative Indian sources.</p>
              </div>

              <div className="bg-neutral-900/50 border border-neutral-800 rounded-2xl p-6">
                <h3 className="text-xl font-bold text-white">Dr. Dangs Lab LIMS</h3>
                <p className="text-neutral-300 mt-2">HIPAA-compliant Laboratory Information Management System processing 10,000+ monthly medical records with real-time reporting and OCR automation.</p>
              </div>
            </div>
          </section>
          ...
          <section className="mb-12">
            ...
            <div className="bg-neutral-900/50 border border-neutral-800 rounded-2xl p-6">
              ...
              <p className="text-neutral-400 mt-1">B.Tech in Computer Science | 2019 - 2023</p>
            </div>
          </section>
          ...
          <section className="mb-12">
            ...
            <div className="grid md:grid-cols-2 gap-4">
              <a href="mailto:tusharagrawal0104@gmail.com" className="flex items-center gap-3 bg-neutral-900/50 border border-neutral-800 rounded-2xl p-4 hover:border-blue-500/50 transition-colors">
                <svg className="w-6 h-6 text-blue-400" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M3 8l7.89 5.26a2 2 0 002.22 0L21 8M5 19h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v10a2 2 0 002 2z" />
                </svg>
                <span className="text-neutral-300">tusharagrawal0104@gmail.com</span>
              </a>

              <a href="tel:+918126816664" className="flex items-center gap-3 bg-neutral-900/50 border border-neutral-800 rounded-2xl p-4 hover:border-blue-500/50 transition-colors">
                <svg className="w-6 h-6 text-blue-400" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M3 5a2 2 0 012-2h3.28a1 1 0 01.948.684l1.498 4.493a1 1 0 01-.502 1.21l-2.257 1.13a11.042 11.042 0 005.516 5.516l1.13-2.257a1 1 0 011.21-.502l4.493 1.498a1 1 0 01.684.949V19a2 2 0 01-2 2h-1C9.716 21 3 14.284 3 6V5z" />
                </svg>
                <span className="text-neutral-300">+91-8126816664</span>
              </a>

              <a href="https://www.linkedin.com/in/tushar-agrawal-91b67a28a" target="_blank" rel="noopener noreferrer" className="flex items-center gap-3 bg-neutral-900/50 border border-neutral-800 rounded-2xl p-4 hover:border-blue-500/50 transition-colors">
              ...
              <a href="https://github.com/Tushar010402" target="_blank" rel="noopener noreferrer" className="flex items-center gap-3 bg-neutral-900/50 border border-neutral-800 rounded-2xl p-4 hover:border-blue-500/50 transition-colors">
                <svg className="w-6 h-6 text-blue-400" fill="currentColor" viewBox="0 0 24 24">
