      ...
      <button
        ...
        className={`group flex items-center gap-3 px-4 py-2.5 rounded-full transition-all duration-300 border ${
          isActive
            ...
            : 'bg-neutral-900/60 border-neutral-700/50 hover:border-blue-500/40 hover:bg-blue-500/5 text-neutral-300 hover:text-white'
        }`}
      >
        ...
        <span className="text-xs text-neutral-500">{Math.ceil(dur / 60)} min</span>
      </button>
            ...
            {isExpanded && (
              <div className="bg-neutral-950 border border-neutral-800 rounded-2xl shadow-2xl shadow-black/50 overflow-hidden">
                ...
                <div className="flex items-center justify-between px-5 pt-5 pb-3">
                  ...
                  <button
                    onClick={() => setIsExpanded(false)}
                    className="p-2 text-neutral-500 hover:text-white hover:bg-neutral-800 rounded-full transition-colors flex-shrink-0"
                  >
                ...
                <div className="flex items-center justify-center gap-6 py-5">
                  <button onClick={skipBack} className="p-2 text-neutral-400 hover:text-white transition-colors active:scale-90">
                  ...
                  <button onClick={skipFwd} className="p-2 text-neutral-400 hover:text-white transition-colors active:scale-90">
                ...
                <div className="px-5 pb-4">
                  <div className="flex items-center gap-2 bg-neutral-900 rounded-xl p-2">
                    <span className="text-[10px] text-neutral-500 uppercase tracking-wider font-semibold w-10">Speed</span>
                    <div className="flex items-center gap-1 flex-1">
                      <button onClick={() => setSpeedVal(Math.round((speed - 0.25) * 100) / 100)} className="p-1 text-neutral-500 hover:text-white rounded transition-colors">
                ...
                <div className="px-5 pb-5 flex items-center gap-2">
                  <button
                    ...
                    className={`p-2 rounded-lg transition-colors flex-shrink-0 ${
                      isMuted ? 'text-red-400 bg-red-500/10' : 'text-neutral-500 hover:text-white hover:bg-neutral-800'
                    }`}
                  >
                  ...
                  {voices.length > 1 && (
                    <select
                      ...
                      className="flex-1 bg-neutral-900 border border-neutral-800 text-neutral-400 text-xs rounded-lg px-3 py-2 focus:outline-none focus:border-neutral-700 truncate appearance-none"
                    >
                      {voices.map((v) => <option key={v.name} value={v.name}>{v.name}</option>)}
                    </select>
                  )}
                  <button onClick={stop} className="p-2 text-neutral-500 hover:text-red-400 hover:bg-red-500/10 rounded-lg transition-colors flex-shrink-0" title="Stop">
              ...
              <div className="bg-neutral-950/95 backdrop-blur-md border-t border-neutral-800 shadow-[0_-4px_20px_rgba(0,0,0,0.5)]">
                ...
                <div className="flex items-center gap-2 px-3 py-2 sm:px-4 sm:py-2.5">
                  ...
                  <div className="hidden sm:flex items-center gap-1">
                    <button onClick={skipBack} className="p-1.5 text-neutral-500 hover:text-white transition-colors">
                      <SkipBack className="w-4 h-4" />
                    </button>
                    <button onClick={skipFwd} className="p-1.5 text-neutral-500 hover:text-white transition-colors">
                  ...
                  <button
                    ...
                    className="px-2 py-1 text-[10px] font-bold text-neutral-400 bg-neutral-800 rounded-md hover:text-white hover:bg-neutral-700 transition-colors flex-shrink-0"
                  >
                    {speed}x
                  </button>

                  {/* Expand */}
                  <button onClick={() => setIsExpanded(true)} className="p-1.5 text-neutral-500 hover:text-white transition-colors flex-shrink-0">
                    <ChevronUp className="w-4 h-4" />
                  </button>

                  {/* Close */}
                  <button onClick={stop} className="p-1.5 text-neutral-500 hover:text-red-400 transition-colors flex-shrink-0">
                    <X className="w-4 h-4" />
                  </button>
                </div>
